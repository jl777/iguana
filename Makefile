...
SOURCES = main.c iguana777.c iguana_init.c iguana_json.c iguana_recv.c iguana_chains.c iguana_ramchain.c iguana_rpc.c iguana_bundles.c iguana_pubkeys.c iguana_msg.c iguana_kv.c iguana_blocks.c iguana_utils.c iguana_peers.c curve25519.c curve25519-donna.c inet.c cJSON.c ramcoder.c

...
#define IGUANA_MAXPENDING 32 // 8
#define IGUANA_PENDINGBUNDLES 32 //512
...
struct iguana_info
{
    ...
    int32_t numpendings,zcount,recvcount,bundleswidth,bcount,pcount; uint32_t recvtime,hdrstime;

...
#define IGUANA_MAXPACKETSIZE (1024 * 1024 + 65536)
...
struct iguana_spend { uint32_t unspentind,prevspendind:31,diffsequence:1; } __attribute__((packed)); // dont need nextspend

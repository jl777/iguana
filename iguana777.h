...
#define _IGUANA_MAXPENDING 16    //64
...
struct iguana_spend { uint32_t spendtxidind,prevspendind; int16_t prevout:14,external:1,diffsequence:1; } __attribute__((packed));
